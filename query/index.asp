...
%>
<title>搜寻：<%=search_q%> - 电脑知识学习—计算机基础知识博客</title>
...
<div id="wrapper">
	<div id="header-wrapper">
		<div id="header">
			<div id="logo">
		<h1><a href="/" title="电脑知识学习—计算机基础知识博客">电脑知识学习—计算机基础知识博客</a></h1>		
	...
	<div id="menu-wrapper">
		<div id="menu">
<ul><li><a href='/' >首 页</a></li> <li><a href='/blog/' >博 客</a></li> <li><a href='/album/' >相 册</a></li> <li><a href='/Category/About' >关 于</a></li> <li><a href='/FeedBack/' >留 言</a></li> <li><a href='/Category/Contact' >联 系</a></li> <li><a href='http://www.66diannao.com/' target='_blank'>官方网站</a></li> </ul>	
                </div>
	</div>
	<!-- end #menu -->
	<div id="page">
...
onfocus="if(this.value=='Input Keywords ...') this.value='';" value="Input Keywords ..." /><input type="submit" id="search-submit" value="搜 寻" />
				</fieldset>
			</form>
		</div>
		<div class="clearfix"></div>
				...
				<li>
					...
					<p class="myintro">电脑知识<br>2013年05月04日<br>中国 上海<br>121673232@qq.com</p>
...
<!--slide album end-->
				...
				<li>
					<h2>博客分类</h2>
<ul><li><a href='/Category/Enterntainment/'>娱乐资讯</a> (3) <a href='/rss/Feed.asp?CatID=133' target='_blank'><img src='/images/rss_icon.gif'></a></li><li><a href='/Category/Love/'>情感天地</a> (2) <a href='/rss/Feed.asp?CatID=135' target='_blank'><img src='/images/rss_icon.gif'></a></li><li><a href='/Category/Internet/'>互联网</a> (6) <a href='/rss/Feed.asp?CatID=136' target='_blank'><img src='/images/rss_icon.gif'></a></li><li><a href='/Category/Favorite/'>个人收藏</a> (1) <a href='/rss/Feed.asp?CatID=138' target='_blank'><img src='/images/rss_icon.gif'></a></li><li><a href='/Category/Diary/'>个人日记</a> (1) <a href='/rss/Feed.asp?CatID=137' target='_blank'><img src='/images/rss_icon.gif'></a></li></ul>
				</li>
				<li>
					<h2>热门文章</h2>
...
<div id="footer">
	<p>Copyright &copy; 2012 海纳个人博客系统Britar Yao All rights reserved<BR> Powered by 博客程序 <img src="/images/hituxblog-logo.png" width="80" alt='HituxBlog V1.4'> <a href="/rss" target="_blank"><img src="/images/rss_icon.gif"></a> <a href="/rss/feed.xml" target="_blank"><img src="/images/xml_icon.gif"></a> Themes By <A href="http://www.66diannao.com/" target=_blank>电脑知识</a>
</p>
</div>
<!-- end #footer -->
</body>
